...
module.exports = {
   ...
   getUserById : (req, res)=>{
      ...
      return res.status(200).json(`Function: getUserById`)
   },
   ...
   createUser : (req, res)=>{
      ...
      return res.status(200).json(`Function createUser`)
   },
   ...
   updateUser : (req, res)=>{
      ...
      return res.status(200).json(`Function updateUser`)
   },
   ...
   deleteUser : (req, res)=>{
      ...
      return res.status(200).json('Function deleteUser')
   }
}